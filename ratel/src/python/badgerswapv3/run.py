...
from ratel.genfiles.python.badgerswapv3 import (
...
if __name__ == "__main__":
    ...
    server = Server(serverID, db, http_host, http_port + int(serverID))

    loop = asyncio.get_event_loop()
    tasks = [
        monitorSecretDeposit(web3, db, serverID, appContract, confirmation, account),
